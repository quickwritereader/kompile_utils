    ...
    def __init__(self, dataset: Dataset[T_co], batch_size: Optional[int] = 1,
        ...
        *, prefetch_factor: int = 2,
        ...
        super().__init__(dataset=dataset, batch_size=batch_size, shuffle=shuffle, sampler=sampler, batch_sampler=batch_sampler, \
                         num_workers = num_workers, collate_fn=collate, pin_memory = pin_memory, drop_last =drop_last , timeout =timeout, \
                         worker_init_fn=worker_init_fn, multiprocessing_context =multiprocessing_context, \
                         generator = generator, prefetch_factor=prefetch_factor, persistent_workers =persistent_workers, pin_memory_device=pin_memory_device)
